...
• CST                        - Cyber Security Test (port, fuzzer, sqli, xss, dll.)""",
...
[0] Kembali""",
  ...
  lang set <kode>   - alias dari lang -C""",
    ...
    "cst.input_choice": "Pilihan: ",
    "cst.port_range": "Port range (default 1-1024): ",
    "cst.target_required": "Target diperlukan!",
    "cst.range_error": "Format range salah. Contoh: 1-1024",
    "cst.scanning": "Scanning {target}...",
    "cst.scanning_progress": "Scanning... {current}/{total}",
    "cst.found_ports": "Port terbuka ditemukan: {n}",
    "cst.no_open_ports": "Tidak ada port terbuka ditemukan",
    "cst.scan_timeout": "Scan timeout!",
    "cst.scan_error": "Error scan: {e}",
    "cst.dir_fuzz_title": "Directory Fuzzer",
    "cst.dir_fuzz_wordlist": "Wordlist bawaan: admin, login, dashboard, dll. ('custom' untuk upload file)",
    "cst.wordlist": "Masukkan path wordlist (Enter=default, 'custom'=custom): ",
    "cst.wordlist_error": "Wordlist tidak ditemukan, pakai default",
    "cst.fuzz_progress": "Fuzzing... {current}/{total}",
    "cst.fuzz_found": "Path ditemukan: {n}",
    "cst.fuzz_none": "Tidak ada path ditemukan",
    "cst.subdomain_title": "Subdomain Enumeration",
    "cst.subdomain_no_subfinder": "subfinder tidak ditemukan, pakai bruteforce",
    "cst.subdomain_found": "Subdomain ditemukan: {n}",
    "cst.subdomain_none": "Tidak ada subdomain ditemukan",
    "cst.subdomain_progress": "Enumerating... {current}/{total}",
    "cst.sqli_title": "SQL Injection Scanner",
    "cst.sqli_found": "Vulnerabilitas SQLi ditemukan: {n}",
    "cst.sqli_none": "Tidak ditemukan vulnerability SQLi",
    "cst.xss_title": "XSS Scanner",
    "cst.xss_found": "Vulnerabilitas XSS ditemukan: {n}",
    "cst.xss_none": "Tidak ditemukan vulnerability XSS",
    "cst.login_title": "Login Testing",
    "cst.login_no_form": "Tidak ada form login ditemukan",
    "cst.login_has_form": "Form login ditemukan!",
    "cst.login_no_fields": "Tidak ada field yang ditemukan",
    "cst.login_brute_hint": "Ingin brute force? (y/n): ",
    "cst.brute_confirm": "Konfirmasi brute force (y/n): ",
    "cst.brute_start": "Brute force dimulai...",
    "cst.brute_done": "Brute force selesai!",
    "cst.login_simple_mode": "Mode sederhana (requests tidak tersedia)",
    "cst.rev_shell_title": "Reverse Shell Generator",
    "cst.rev_shell_info": "Generator reverse shell payloads",
    "cst.lhost": "LHOST: ",
    "cst.lport": "LPORT: ",
    "cst.rev_shell_options": "Pilih jenis reverse shell:",
    "cst.rev_shell_generated": "Reverse shell di-generate:",
    "cst.save_payload": "Simpan payload? (y/n): ",
    "cst.cve_title": "CVE Checker",
    "cve_info": "Cek vulnerability yang dikenal",
    "cst.cve_found": "CVE ditemukan: {n}",
    "cst.cve_none": "Tidak ditemukan CVE untuk \"{target}\"",
    "cst.cve_known_targets": "Target yang dikenal:",
    "cst.save_cve": "Simpan report? (y/n): ",
    "cst.exiting": "Keluar dari CST...",
    "cst.bad_choice": "Pilihan tidak valid!",
    "cst.selected": "Selected:",
    "cst.press_enter": "Tekan Enter untuk lanjut...",
}
...
AI_TOPICS = {
    ...
    "cst.scan_error": "Error scan: {e}",
    "cst.dir_fuzz_title": "Directory Fuzzer",
    "cst.dir_fuzz_wordlist": "Wordlist bawaan: admin, login, dashboard, dll. (kata 'custom' untuk upload file)",
    "cst.wordlist": "Masukkan path wordlist (Enter=default, 'custom'=custom): ",
    "cst.wordlist_error": "Wordlist tidak ditemukan, pakai default",
    "cst.fuzz_progress": "Fuzzing... {current}/{total}",
    "cst.fuzz_found": "Path ditemukan: {n}",
